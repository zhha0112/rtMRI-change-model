...
from network import *
from preprocess import collate_fn_transformer, get_dataset
...
def main():
    metadata_file = 'F:/train_files.txt'
    vid_feature_file = 'resnet_features_train.pt'
    dataset = get_dataset(metadata_file, vid_feature_file)
    global_step = 0
    ...
    for epoch in range(hp.epochs):
        ...
        for i, data in enumerate(pbar):
            ...
            vid, mel, mel_input, pos_vid, pos_mel, _ = data
            ...
            mel_pred, postnet_pred, attn_probs, stop_preds, attns_enc, attns_dec = m.forward(vid, mel_input, pos_vid,
                                                                                             pos_mel)
